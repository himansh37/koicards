...
- **Light/dark theme toggle.** The CSS variables and a `DeckManager.getTheme()/setTheme()` already exist in the code — nobody ever wired a button to them. This is close to a free feature.
